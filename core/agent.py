...
console = Console()
HIGH_RISK_PATTERNS = [
    r"hack", r"exploit", r"payload", r"metasploit", r"nmap", r"sqlmap", r"keylog",
    r"rat\b", r"backdoor", r"rootkit", r"c2\b", r"reverse.?shell", r"bind.?shell",
...
class JagXAgent:
    ...
    def _needs_confirmation(self, name: str, arguments: Dict[str, Any]) -> bool:
        ...
        return name in SENSITIVE_TOOLS or any(re.search(p, text, re.I) for p in HIGH_RISK_PATTERNS)
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                console.print("[bold orange1]JagX:[/bold orange1]"); console.print(Markdown(response))
