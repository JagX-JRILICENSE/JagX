...
SENSITIVE_TOOLS={"run_shell","run_project_tests","delete_path","uninstall_app","write_file","write_text_file","set_clipboard","save_credential","create_project_structure","kill_process_by_name","block_camera_access","build_project","apply_file_patch","close_application","copy_path","move_path","create_folder","browser_download","shutdown_windows","restart_windows","sleep_windows","hibernate_windows","set_idle_policy","lock_workstation","empty_recycle_bin","open_run_dialog","copy_text_to_clipboard","drag_mouse","double_click","scroll_mouse","close_active_window","clear_temp_files","set_file_permissions","prepend_text_file","append_text_file","make_empty_file","zip_path","unzip_path","copy_file_path","toggle_windows_theme","launch_task_scheduler","launch_services","launch_device_manager","launch_disk_management","launch_event_viewer","move_cursor_to","click_cursor"}
class JagXAgent:
